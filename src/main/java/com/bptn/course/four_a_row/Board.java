...
//        }
		...
		// what condition should be here to allow you to keep searching for the right
	...
	public boolean checkHorizontal(String playerNumber) {
		for (int col = 0; col < board[0].length - 3; col++) {
			// try implementing this by being inspired by the checkVertical logic. Note
			// avoid off by 1 errors. Also remember that you are now checking across columns
			// within each row this time.
